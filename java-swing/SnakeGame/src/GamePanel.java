...
public class GamePanel extends JPanel implements ActionListener{
	...
	public void draw(Graphics g) {
		...
		if(running) {
			...
			g.drawString("Score " + applesEaten, (SCREEN_WIDTH - metrics1.stringWidth("Score " + applesEaten))/2, UNIT_SIZE);
	...
	public void gameOver(Graphics g) {
		...
		g.setFont(new Font("Ink Free", Font.BOLD, 30));
		FontMetrics metrics1 = getFontMetrics(g.getFont());
		g.drawString("Score " + applesEaten, (SCREEN_WIDTH - metrics1.stringWidth("Score " + applesEaten))/2, (SCREEN_HEIGHT-8*UNIT_SIZE)/2);
